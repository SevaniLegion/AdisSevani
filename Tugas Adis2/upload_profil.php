...
<div class="container py-5">
    <div class="row justify-content-center">
        <div class="col-lg-6">
                ...
                <div class="card-body">
                    <form action="" method="post" enctype="multipart/form-data">
                        <div class="mb-3">
                            ...
                            <input type="number" name="id_pengguna" id="id_pengguna" class="form-control" placeholder="Contoh: 1" required>
                        </div>
                        <div class="mb-3">
            ...
            <div class="footer">
                <span>Dibuat oleh: <strong>Adis Sevani</strong> | NIM: <strong>A12.2023.07067</strong></span>
            </div>
